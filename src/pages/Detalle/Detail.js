...
import { Reserve, ReserveDTO } from "../../domain/Reserve";
...
const Detail = () => {
    ...
    const makeReserve = async (e) => {
        ...
        const reservation = Object.assign(new ReserveDTO(), reserve)
                ...
                <Stack p={3} gap={3} className="detalle-view" flexDirection={"column"} flexWrap={"wrap"} alignContent={"center"} >
                    ...
                    <Stack justifyContent={"space-between"} flexDirection={"row"}>
                        <Stack flexDirection={"row"}>
                            ...
                            <p className="bold-text">{lodgment.rateAverage} puntos</p>  <p> - {lodgment.rateCount} opiniones</p> 
                        </Stack>
                        <Stack flexDirection={"row"}>
